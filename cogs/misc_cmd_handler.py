...
class MiscCommands:
    ...
    async def profile(self, ctx):
        ...
        "$profile"
        """
        await self.cmd_function.display_bot_profile(ctx)
    ...
    async def updates(self, ctx):
        ...
        "$updates"
        """
        await self.cmd_function.display_update_page(ctx)
    ...
    async def donate(self, ctx):
        ...
        "$donate"
        """
        await self.cmd_function.display_donation_option(ctx)
    ...
    async def info(self, ctx):
        ...
        "$info"
        """
        await self.cmd_function.display_info(ctx)
